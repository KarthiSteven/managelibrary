		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Author",
									"targetURL": "#authorMasterlibrary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"authorMasterlibrary-display": {
								"semanticObject": "authorMasterlibrary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=authorMaster.library",
									"url": sap.ui.require.toUrl("authorMaster/library")
								}
							}
						}
					}
